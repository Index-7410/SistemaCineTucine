  ...
  <ul>
    ...
    <li><a href="add_ticket.php" class="btn-floating green"><i class="material-icons">add</i></a></li>
     <li><a href="boletos_reservados.php" class="btn-floating green"><i class="material-icons">save</i></a></li>
